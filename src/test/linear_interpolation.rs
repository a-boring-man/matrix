...
mod test {
	...
	fn linear_interpolation() {
		...
		let v3 = Vector::from(vec![Complex{re: 1.0, im: 4.0}, Complex{re: -6., im: 3.}]);
		let v4 = Vector::from(vec![Complex{re: 5., im: 2.}, Complex{re: 2.0, im: 5.0}]);
		...
		assert_eq!(Vector::from(vec![Complex{re: 3., im: 3.0}, Complex{re: -2., im: 4.}]), Vector::lerp(&v3, &v4, &Complex{re: 0.5, im: 0.0}));
		assert_eq!(Vector::from(vec![Complex{re: 1.0, im: 4.0}, Complex{re: -6., im: 3.}]), Vector::lerp(&v3, &v4, &Complex{re: 0.0, im: 0.0}));
		assert_eq!(Vector::from(vec![Complex{re: 5., im: 2.}, Complex{re: 2.0, im: 5.0}]), Vector::lerp(&v3, &v4, &Complex{re: 1.0, im: 0.0}));
