...
mod tests {
    ...
    fn add() {
        ...
        let m4 = Matrix::from((vec![Complex( 5., 6.), Complex( 6.,  7.), Complex( 7.,  8.), Complex( 8.,  9.)], 2, 2));
        let v3 = Vector {v: vec![Complex( 1., 2.), Complex( 2.,  3.), Complex( 3.,  4.), Complex( 4.,  5.)]};
        let v4 = Vector {v: vec![Complex( 5., 6.), Complex( 6.,  7.), Complex( 7.,  8.), Complex( 8.,  9.)]};
