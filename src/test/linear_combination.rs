...
mod tests {
    ...
    fn linear_combination() {
        ...
        let vc = Vector::from(vec![Complex( 1.,  2.), Complex( 2.,  3.), Complex( 3.,  4.)]);
        ...
        assert_eq!(Vector::from(vec![Complex( 0.5,  8.5), Complex( 2.5,  13.5), Complex( 4.5,  18.5)]), Vector::linear_combination(&[vc], &[Complex( 3.5,  1.5)]));
    }
}